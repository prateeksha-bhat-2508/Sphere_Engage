 ...
 *
 * @description If the email domain of the user's email is "mod.SphereEngage.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.SphereEngage.com" ? "moderator" : "general";
